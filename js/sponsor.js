...
$jq3.fn.liScroll = function (settings) {
  settings = $jq3.extend(
    {
      travelocity: 0.03,
    },
  ...
  return this.each(function () {
    ...
    var stripHeight = 0;
    $strip.find("li").each(function () {
      stripHeight += $jq3(this).outerHeight(true);
    });
...
$jq3(function () {
  ...
  $jq3.fn.liScroll = function (settings) {
    ...
    return this.each(function () {
      ...
      var stripWidth = 0;
      $strip.find("li").each(function () {
        stripWidth += $jq3(this).outerWidth(true);
      });
